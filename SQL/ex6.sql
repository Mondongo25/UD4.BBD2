...
-- Table `EX6`.`AVION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EX6`.`AVION` (
  `ID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `EX6`.`RESERVA` (
  ...
  CONSTRAINT `fk_RESERVA_VUELO1`
    ...
    REFERENCES `EX6`.`VUELO` (`NUM.VUELO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_RESERVA_PASAJERO1`
    FOREIGN KEY (`PASAJERO_ID`)
    REFERENCES `EX6`.`PASAJERO` (`DNI_PASAPORTE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `EX6`.`citas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EX6`.`citas` (
...
-- Table `EX6`.`Vehiculo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EX6`.`Vehiculo` (
...
-- Table `EX6`.`Clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EX6`.`Clientes` (
  `DNI` INT NOT NULL,
  `nombre` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Clientes_Vehiculo1`
    ...
    REFERENCES `EX6`.`Vehiculo` (`numero_matriculas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
